...
#define NATIVE_LOG(fmt, ...)                                                  \
    printf(NATIVE_COLOR NATIVE_MSG_PREFIX "[%s:%d] " NATIVE_SUFFIX_COLOR fmt, \
           DOODLE_FILENAME, DOODLE_LINE, ##__VA_ARGS__)

#define NATIVE_LOG_ERROR(fmt, ...)                                                         \
    printf(NATIVE_ERROR_COLOR NATIVE_MSG_PREFIX "[%s:%d][ERROR] " NATIVE_SUFFIX_COLOR fmt, \
           DOODLE_FILENAME, DOODLE_LINE, ##__VA_ARGS__)
#else
